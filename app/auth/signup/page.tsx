                    ...
                    <div className="w-full max-w-md text-center">
                         <div className="card-container space-y-4">
                              ...
                              <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-6 space-y-3">
                                   <p className="text-green-300 font-semibold text-lg">✓ Account created successfully!</p>
                                   <p className="text-gray-300 text-sm leading-relaxed">{success}</p>
                                   <div className="pt-3 border-t border-green-500/20 space-y-2 text-xs text-gray-400">
                                        <p>📬 <span className="font-semibold">Check your email inbox</span> for a verification link from RecallAI</p>
                                        <p>✅ Click the link to verify your email address</p>
                                        <p>🔑 After verification, you can sign in with your email and password</p>
                                   </div>
                                   <p className="text-gray-400 text-xs pt-2">Redirecting to login in 4 seconds...</p>
                              </div>
                         </div>
                    </div>
               </div>
          ...
          <div className="flex items-center justify-center min-h-screen px-4">
               <div className="w-full max-w-md">
                    ...
                    <div className="text-center mb-8">
                         ...
                         <p className="text-gray-400 text-lg">Start mastering with spaced repetition</p>
                    </div>
                    ...
                    <div className="card-container mb-6 space-y-6">
                         ...
                         <div className="pt-2 text-center">
                              <p className="text-gray-400 text-sm">
                                   ...
                                   <Link href="/auth/login" className="text-accent-amber hover:text-accent-amber/80 font-semibold transition-colors">
                                        Sign in
                                   </Link>
                              </p>
                         </div>
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4 text-blue-300 text-sm space-y-2">
                         ...
                         <ul className="text-xs leading-relaxed space-y-1 text-blue-200">
                              <li>✓ After signing up, a verification email will be sent</li>
                              <li>✓ Check your inbox and click the verification link</li>
                              <li>✓ After verifying, you can sign in with your password</li>
                         </ul>
                         <p className="text-xs text-blue-300/70 pt-2">💡 Tip: Check spam folder if you don't see the email</p>
                    </div>
               </div>
          </div>
     );
